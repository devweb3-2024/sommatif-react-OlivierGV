...
function App() {
  ...
  // ER: Ça aurait été plus élégant de faire une variable avec le message à afficher et de l'afficher à la fin
  return (
    <div className="jeu">
      <h1>Jeu de mémoire</h1>
      <p>Nombre de coups : {nombreCoups}</p>
      {!partieEnCours && nombreCoups == 0 ? <p>Partie perdue!</p> : <></>}
      {!partieEnCours && nombreCoups > 0 ? <p>Partie gagnée!</p> : <></>}
      {!partieEnCours ? (
        <>
